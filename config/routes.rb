Rails.application.routes.draw do
  ...
  delete '/lists/:id', to: 'lists#destroy', as: "lists_destroy"
  ...
  delete '/movies/:id', to: 'movies#destroy', as: "movies_destroy"
  ...
  delete '/places/:id', to: 'places#destroy', as: "places_destroy"
  ...
  delete '/randos/:id', to: 'randos#destroy', as: "randos_destroy"
  ...
  delete '/songs/:id', to: 'songs#destroy', as: "songs_destroy"
